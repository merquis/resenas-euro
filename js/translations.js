...
export const translations = {
  es: {
    ...
    // Formulario - NO PARECE FORMULARIO
    improveQuestion: '¿Dónde enviamos tu PREMIO? 🎁',
    namePlaceholder: 'Nombre del GANADOR',
    emailPlaceholder: 'Email para tu CÓDIGO PREMIO',
    feedbackPlaceholder: 'Cuéntanos qué no te gustó (opcional)',
    ...
    // Confirmshaming para menos de 5 estrellas
  ...
  en: {
    ...
    finishReview: '⚠️ ACTIVATE NOW on Google or it will EXPIRE',
    improveQuestion: 'Where should we send your PRIZE? 🎁',
    namePlaceholder: 'WINNER\'s Name',
    emailPlaceholder: 'Email for your PRIZE CODE',
  ...
  de: {
    ...
    finishReview: '⚠️ JETZT bei Google AKTIVIEREN oder er VERFÄLLT',
    improveQuestion: 'Wohin sollen wir Ihren PREIS senden? 🎁',
    namePlaceholder: 'Name des GEWINNERS',
    emailPlaceholder: 'E-Mail für Ihren PREIS-CODE',
  ...
  fr: {
    ...
    finishReview: '⚠️ ACTIVEZ MAINTENANT sur Google ou il EXPIRERA',
    improveQuestion: 'Où devons-nous envoyer votre PRIX? 🎁',
    namePlaceholder: 'Nom du GAGNANT',
    emailPlaceholder: 'Email pour votre CODE PRIX',
    ...
    shameLowRating: 'Non, je préfère payer le prix complet',
