...
export const translations = {
  ...
  en: {
    ...
    improveQuestion: 'Complete your review and join the RAFFLE! 🎁',
    namePlaceholder: 'Your full name',
    emailPlaceholder: 'Your email',
    feedbackPlaceholder: 'Complete your restaurant review',
    submitBtn: 'SEND & WIN',
  ...
  de: {
    ...
    improveQuestion: 'Vervollständigen Sie Ihre Bewertung und nehmen Sie an der VERLOSUNG teil! 🎁',
    namePlaceholder: 'Ihr vollständiger Name',
    emailPlaceholder: 'Ihre E-Mail',
    feedbackPlaceholder: 'Vervollständigen Sie Ihre Restaurant-Bewertung',
  ...
  fr: {
    ...
    improveQuestion: 'Complétez votre avis et participez au TIRAGE AU SORT! 🎁',
